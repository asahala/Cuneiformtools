...
def _collect_phonemic(phonemic):
...
def get_readings(sign, sort=False):
    """ Return name of the cuneiform sign
...
def get_homophones(reading, sort_by='reading', sort=False):
    ...
    found = list(_collect_phonemic(phonemic))
...
def contains_sign(sign, position='', sort=False):
...
def _map_signs(xlit):
    """ Helper transducer method for sign-level tokenization """
...
def compare_xlit(xlit1, xlit2):
    ...
    """
    return _map_signs(xlit1) == _map_signs(xlit2)
